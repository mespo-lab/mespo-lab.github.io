...
- **Planning and operation of integrated-energy systems:** (islanded/grid-connected) microgrids, ships, seaports, smart buildings, etc., with integrated power, thermal, and gas networks.
- **Tackling diverse uncertainties:** those from renewable energies, outdoor temperature, gas prices, and ship swinging with the multi-stage (distributional) robust/stochastic optimization methods in multi-energy systems.
...
- **Advanced algorithms development and application in multi-energy operations** approximate dynamic programming, deep reinforcement learning, machine learning, etc.
